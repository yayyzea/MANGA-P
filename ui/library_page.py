    ...
    def __init__(self, manga, entry_id: int, show_labels: bool = True,
        ...
        if mode in ("chapter", "status"):
            ...
            if mode == "chapter":
                ...
                # Kalau jumlah chapter tidak diketahui, pakai max dari current+10 atau minimal 10
            ...
            # Masukkan combo ke dalam layout card langsung
